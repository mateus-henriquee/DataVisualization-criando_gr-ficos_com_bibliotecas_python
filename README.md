...
![Preview do Notebook](prev/notebook-cap.png)
...
![Preview Gráfico Interativo](prev/prev-grafico-interativo.png)
...
1. **Execute as linhas de código uma por uma ou rode tudo de uma vez** 😄
   ![Preview do Botao De Executar Tudo](fotos/executar-tudo.png)

---

![Preview Gráfico Simples](prev/prev-grafico.png)
